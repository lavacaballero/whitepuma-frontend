<?php
    ...
    class cli
    {
        ...
        public static function color($text, $foreground, $background = NULL)
        {
            ...
            if(self::$use_utf8) return utf8_encode($string);
            else                return $string;
        } # end function
        ...
        public static function write($text = '', $foreground = NULL, $background = NULL)
        {
            ...
            # fwrite(STDOUT, $text);
            if  (self::$use_utf8 AND ($foreground OR $background)) echo $text;
            elseif(self::$use_utf8)                                echo utf8_encode($text);
            else                                                   echo $text;
        } # end function

        /**
        * Convierte código escapeado a HTML con spans de color
        *
